<template lang="html">
  ...
  <section class="login">
    ...
    <form>
      ...
      <input type="text" id="password" class="fadeIn first" name="login" placeholder="password" v-model="cont"><br>
      ...
      <button class="btn bg-primary" v-on:click="add">Registrar</button>
